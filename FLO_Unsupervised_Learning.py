...
#Burası tüm değişkenlerin çarpıklık durumlarını kontrol etmek için kullandıgımız bir fonksıyon;
#Peki neden çarpıklıklarına bakıyoruz. Normal dağılım sağlayıp sağlamadıklarının kontrolü için
...
## KULLANILACAK IKI YONTEM COMPLETE VE AVERAGE'DAN COMPLETE E UYGULUYORUZ.
...
#küme sayısı 5 belirlendi

# 2. Modelinizi oluşturunuz ve müşterileriniz segmentleyiniz.

# Final Modeli Oluşturmak (5 küme ile)
